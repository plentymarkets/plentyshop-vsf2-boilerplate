  ...
  <client-only>
    ...
    >
      <div v-if="!furtherSettingsOn">
        ...
        <div
          v-if="cookieJson"
          class="flex flex-col md:flex-row flex-wrap md:flex-nowrap ml-sf-xs justify-between"
        >
          <div
      ...
      <div
        v-else
        class="overflow-y-auto h-80 bg-sf-c-light-primary-lighten px-2 pb-2"
      >
        <div
